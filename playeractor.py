...
from misc import *
from util import sign, IMAGE_EXT
...
class PlayerActor(BasicRobot):
    ...
    def __init__(self,location=None,angle=90,velocity=0,
                 hitpoints=20, thrust=0, world=None):
        ...
        BasicRobot.__init__(self, location=location, angle=angle, velocity=velocity, hitpoints=hitpoints, thrust=thrust, world=world)
